...
import com.ogc.standard.dto.req.XN640037Req;
...
public class XN640037 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return ticketAO.queryTicketList(condition);
    }

    @Override
    public void doCheck(String inputparams, String operator)
            throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN640037Req.class);
